...
hist(birthdays$num_twitter_birthday)

twitter_birthday_glm_nb <- glm(num_twitter_birthday ~ num_born + factor(gender) + factor(right_left) + days_served + share_2009.share_2014 + GDP_per_capita_PPS_2013 + WEF_Global_IT_score_2014 + Press_freedom_2014 + Median_age_2014 + Electoral_system, data=birthdays)
