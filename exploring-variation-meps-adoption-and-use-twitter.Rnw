...
<<table_7, cache=FALSE, echo=FALSE, message=FALSE, results='asis'>>=
library(stargazer)
df$num_born <- as.numeric(df$born)
...
on_twitter_logit <- glm(on_twitter ~ num_born + factor(gender) + factor(right_left) + days_served + share_2009.share_2014 + GDP_per_capita_PPS_2013 + WEF_Global_IT_score_2014 + Press_freedom_2014 + Median_age_2014 + Electoral_system, data=df, family="binomial")

#print(xtable(on_twitter_logit, caption="On Twitter GLM"), caption.placement="top", table.placement="H")
@
...
twitter_birthday_glm_nb <- glm.nb(num_twitter_birthday ~ num_born + factor(gender) + factor(right_left) + days_served + share_2009.share_2014 + GDP_per_capita_PPS_2013 + WEF_Global_IT_score_2014 + Press_freedom_2014 + Median_age_2014 + Electoral_system, data=birthdays)
...
total_tweets_fit_glm_nb <- glm.nb(total_tweets ~ num_born + factor(gender) + factor(right_left) + days_served + share_2009.share_2014 + GDP_per_capita_PPS_2013 + WEF_Global_IT_score_2014 + Press_freedom_2014 + Median_age_2014 + Electoral_system, data=tweeters)
...
library("MASS")
replies_fit_glm_nb <- glm.nb(total_screen_name_replies ~ num_born + factor(gender) + factor(right_left) + days_served + share_2009.share_2014 + GDP_per_capita_PPS_2013 + WEF_Global_IT_score_2014 + Press_freedom_2014 + Median_age_2014 + Electoral_system, data=tweeters)
...
stargazer(on_twitter_logit, twitter_birthday_glm_nb, total_tweets_fit_glm_nb, replies_fit_glm_nb, title="Regression Results", covariate.labels=c("Age", "Gender", "Right Left", "Days Served", "Party Share", "GDP per Captia", "Global IT Score", "Press Freedom", "Median Age", "Electoral System"), dep.var.labels=c("On Twitter", "Twitter Birthday", "Total Tweets", "Total @-Replies"))
@
