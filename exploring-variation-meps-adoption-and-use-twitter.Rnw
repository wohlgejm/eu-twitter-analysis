...
df_ta_c <- sqldf("SELECT nationality,
                 ...
                 FROM df_ta_c_
                 GROUP BY 1,2,3,5")
print(xtable(df_ta_c[with(df_ta_c, order(-percent_off)),], digits=c(0,0,0,0,0,0)), include.rownames=FALSE)
@
...
df_ta_e <- sqldf("SELECT european_party,
                 ...
                 FROM df_ta_e_
                 GROUP BY 1,2,3,5")
print(xtable(df_ta_e[with(df_ta_e, order(-percent_off)),], digits=c(0,0,0,0,0,0)), include.rownames=FALSE)
@
